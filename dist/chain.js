...
// ─── Clients ──────────────────────────────────────────────
const DIAMOND_ADDRESS = (process.env.DIAMOND_ADDRESS || '0x3c1bd1923f8318247e2b60e41b0f280391c4e1e1');
...
export async function assertChainConfigOrThrow() {
    ...
    if (rpcChainId !== avalancheFuji.id) {
        throw new Error(`[chain] Chain mismatch: expected ${avalancheFuji.id} (${avalancheFuji.name}), got ${rpcChainId}. ` +
